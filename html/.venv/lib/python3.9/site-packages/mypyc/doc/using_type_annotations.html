...
<html lang="en" data-content_root="../../../../../../">
  <head>
    ...
    <title>Using type annotations &#8212; ALTS-Documentation 0.1 documentation</title>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Using type annotations</a></li> 
      </ul>
    </div>  
...
heap.  <code class="docutils literal notranslate"><span class="pre">bool</span></code>, <code class="docutils literal notranslate"><span class="pre">None</span></code> and fixed-length tuples are value types.</p>
...
use <code class="docutils literal notranslate"><span class="pre">==</span></code> instead of <code class="docutils literal notranslate"><span class="pre">is</span></code> if you are comparing two integers or
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">example</span><span class="p">()</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Using type annotations</a><ul>
<li><a class="reference internal" href="#primitive-types">Primitive types</a></li>
<li><a class="reference internal" href="#primitive-containers">Primitive containers</a></li>
...
<li><a class="reference internal" href="#erased-types">Erased types</a></li>
<li><a class="reference internal" href="#strict-runtime-type-checking">Strict runtime type checking</a></li>
<li><a class="reference internal" href="#value-and-heap-types">Value and heap types</a></li>
</ul>
</li>
</ul>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../../../../../../_sources/.venv/lib/python3.9/site-packages/mypyc/doc/using_type_annotations.rst.txt"

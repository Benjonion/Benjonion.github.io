...
<html lang="en" data-content_root="../../../../../../">
  <head>
    ...
    <title>Performance tips and tricks &#8212; ALTS-Documentation 0.1 documentation</title>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Performance tips and tricks</a></li> 
      </ul>
    </div>  
...
accesses, just like that.</p>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Performance tips and tricks</a><ul>
<li><a class="reference internal" href="#profiling">Profiling</a></li>
<li><a class="reference internal" href="#avoiding-slow-libraries">Avoiding slow libraries</a></li>
<li><a class="reference internal" href="#type-annotations">Type annotations</a></li>
<li><a class="reference internal" href="#avoiding-slow-python-features">Avoiding slow Python features</a></li>
<li><a class="reference internal" href="#using-fast-native-features">Using fast native features</a></li>
<li><a class="reference internal" href="#adjusting-garbage-collection">Adjusting garbage collection</a></li>
<li><a class="reference internal" href="#fast-interpreter-shutdown">Fast interpreter shutdown</a></li>
<li><a class="reference internal" href="#work-smarter">Work smarter</a></li>
</ul>
</li>
</ul>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../../../../../../_sources/.venv/lib/python3.9/site-packages/mypyc/doc/performance_tips_and_tricks.rst.txt"
